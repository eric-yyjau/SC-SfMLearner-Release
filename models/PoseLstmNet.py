...
def main():
    ...
    model.init_lstm_states(torch.zeros((1,3,120, 160)) )
    # summary(model, input_size=[(3, 240, 320), (3, 240, 320)])
    summary(model, input_size=(3, 120, 160) )
