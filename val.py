...
def main():
    ...
    for epoch in range(1):
        ...
        if args.with_gt:
            ...
            errors, error_names = validate_without_gt(
                args, val_loader, disp_net, pose_net, epoch, logger, training_writer)
        error_string = ', '.join('{} : {:.3f}'.format(name, error)
...
@torch.no_grad()
def validate_without_gt(args, val_loader, disp_net, pose_net, epoch, logger, training_writer=None):
    global device
